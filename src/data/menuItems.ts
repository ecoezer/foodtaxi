...
const createDrinkSizes = (smallPrice: number, largePrice: number = 3.80) => [
...
export const pizzas: MenuItem[] = [
  {
    ...
    allergens: "1,2,3/A,C",
    isWunschPizza: true,
    sizes: createPizzaSizes({ medium: 10.90, large: 12.90, family: 22.90, mega: 31.90 })
  },
  {
    id: 502,
    number: 1,
  ...
  },
  {
    ...
    allergens: "1,2,3,4/A,C",
    isPizza: true,
    sizes: createPizzaSizes({ medium: 11.30, large: 13.30, family: 22.30, mega: 31.30 })
  },
  {
    id: 512,
    number: 11,
  ...
  },
  {
    ...
    allergens: "1,2,3,4/A,C,F,G",
    isPizza: true,
    sizes: createPizzaSizes({ medium: 11.30, large: 13.30, family: 21.30, mega: 31.30 })
  },
  {
    id: 516,
    number: 15,
  ...
  },
  {
    ...
    isPizza: true,
    sizes: createPizzaSizes({ medium: 11.30, large: 14.30, family: 22.30, mega: 31.30 })
  },
  {
    id: 521,
    number: 20,
